...
function Checkout() {
  ...
  const handleCheckout = async (e) => {
    ...
    try {
      const res = await fetch("https://technotronix-api-wi44.onrender.com/payment/initiate", {
        method: "POST",
        headers: {
  ...
  return (
    <div className="lg:flex m-[5%]">
      <div className="w-[70%] lg:w-[50%]">
        <h1 className="font-bold text-center mb-5 pl-16 lg:pl-0">ORDER SUMMARY</h1>
              ...
              <tr className="border-b-2">
                ...
                <td>
                  <div className="flex justify-center">
                    <img
                      src={"https://technotronix-api-wi44.onrender.com/" + item.product.img}
                      className="h-[50px]"
                      alt=""
                    />
                  </div>
      ...
      <div className="w-[90%] lg:w-[50%] ">
        <h1 className="mb-5 font-bold text-center pl-8 pt-8 lg:pt-0">DELIVERY INFORMATION</h1>
